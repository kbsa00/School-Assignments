...
public class Client
{
    ...
    public void mainMethod() {
        ...
        boks.add(new LydBok(34567, "Linn Ullmann", "De utrolige", "Oktober", 8, 10, 410, 5, "Lisa Kolben"));
        boks.add(new LydBok(45678, "Jan-Philipp Sandker", "Mørke skygger", "Cappelen Damm", 4, 1, 352, 8, "Kim Haugen"));
